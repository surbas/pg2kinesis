...
class SlotReader(object):
    ...
    def __init__(self, database, host, port, user, password, sslmode, slot_name,
        ...
        self._db_confg = dict(database=database, host=host, port=port, user=user, password=password, sslmode=sslmode)
